...
def bnsbuy():
    ...
    try:
        ...
        bnsreg()
    try:
        l = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3VhbkdVZjBU'
    ...
    if bns in r:
        ...
        os.system('am start https://wa.me/+8801645137393?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20Niki%20Paid%20Tools.%20My%20Key:%20' + bns)
        bnsbuy()
...
def bnsreg():
    ...
    raw_input('\x1b[1;91m [\x1b[1;92m✓\x1b[1;91m]\x1b[1;92m Press Enter To Buy This Tools')
    os.system('am start https://wa.me/+8801645137393?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20Niki%20Paid%20Tools.%20My%20Key:%20' + id)
